...
static void _send_init(u_int64_t frequency) {
    ...
    unsigned char readRegister[7] = { 0x55, 0xAA, 0x52, 0x05, 0x00, 0x00, 0x0A};
     ...
     unsigned char init7[11] =  { 0x55, 0xAA, 0x51, 0x09, 0x00, 0x3C, 0x80, 0x00, 0x80, 0x20, 0x19 };
     _send_simple(init7, 11);



    // unsigned char init8[11] =  { 0x55, 0xAA, 0x51, 0x09, 0x00, 0x14, 0x00, 0x00, 0x00, 0xFF, 0x08 };
    //  _send_simple(init8, 11);

//      unsigned char init9[11] =  { 0x55, 0xAA, 0x51, 0x09, 0x00, 0x54, 0x00, 0x00, 0x00, 0x03, 0x1D };
//      _send_simple(init9, 11);

//  unsigned char init10[11] =  { 0x55, 0xAA, 0x51, 0x09, 0x00, 0x58, 0x02, 0x11, 0x11, 0x11, 0x06 };
//      _send_simple(init10, 11);

//      unsigned char init11[11] =  { 0x55, 0xAA, 0x41, 0x09, 0x00, 0x2C, 0x00, 0x7C, 0x00, 0x03, 0x03 };
//      _send_simple(init11, 11);

//        unsigned char init12[11] =  { 0x55, 0xAA, 0x41, 0x09, 0x00, 0xA8, 0x00, 0x07, 0x01, 0xF0, 0x15 };
//      _send_simple(init12, 11);

//      unsigned char init13[11] =  { 0x55, 0xAA, 0x41, 0x09, 0x00, 0x18, 0xF0, 0x00, 0xC1, 0x00, 0x0C };
//      _send_simple(init13, 11);

//     unsigned char init14[11] =  { 0x55, 0xAA, 0x41, 0x09, 0x00, 0x3C, 0x80, 0x00, 0x85, 0x40, 0x04 };
//      _send_simple(init14, 11);

//     unsigned char init15[11] =  { 0x55, 0xAA, 0x41, 0x09, 0x00, 0x3C, 0x80, 0x00, 0x80, 0x20, 0x11 };
//      _send_simple(init15, 11);

//      unsigned char init16[11] =  { 0x55, 0xAA, 0x41, 0x09, 0x00, 0x3C, 0x80, 0x00, 0x82, 0xAA, 0x05 };
